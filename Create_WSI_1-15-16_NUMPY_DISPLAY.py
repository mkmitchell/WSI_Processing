...
def doCalc(species, lock=Lock()):
        try:
                ...
                #Create NetCDF file
                        ...
                        model_val_year = ('G:\\WSI data verification\\dataverification\\WSI_DISPLAY_' + species + '.' + yearstr + '.nc')
                        ...
                        model_val_s = nco.createVariable('display_val', 'i',  ('time', 'y', 'x'))
                        model_val_s.units='display value'
                        model_val_s.long_name='Display Value'
...
if __name__ == '__main__':
        ...
        #e = doCalc('abdu')
        specieslist = ('abdu', 'amwi', 'gadw', 'gwte', 'mall', 'nopi', 'nsho')
